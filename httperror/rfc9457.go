...
// NewRFC9457Error creates a new RFC9457Error with the given status, title, and detail.
...
//
// RFC9457 improvements: Better default type handling and improved documentation guidance.
...
// This is useful when you want to use a predefined problem type from the registry
// or a custom problem type specific to your application.
//   - status: The HTTP status code
//   - typeURI: A URI reference that identifies the problem type
//   - title: A short, human-readable summary of the problem type
...
// WithType sets the Type field of the RFC9457Error and returns the RFC9457Error.
// The Type field is a URI reference that identifies the problem type.
// RFC9457 provides improved guidance: when dereferenced, it SHOULD provide human-readable
// documentation for the problem type. Non-dereferenceable URIs are acceptable when they
// serve as unique identifiers.
// Example Type values:
// - "https://example.com/probs/out-of-credit"
// - "https://api.example.org/errors/insufficient-funds"
// - "urn:problem-type:insufficient-funds" (non-dereferenceable but unique)
func (p *RFC9457Error) WithType(typeURI string) *RFC9457Error {
	p.Type = typeURI
	return p
}

// WithCommonType sets the Type field using a predefined common problem type.
